...
select s in "hachiman.nils.moe" "shiina.nils.moe" "vps.nils.moe" "minecraft.nils.moe" "pi@raspberrypi" "nalsai@nanopineo3" "nalsai@odroidxu4" "nalsai@nanopi-r4s" "138.3.248.255 (OpenMPTCProuter)"; do
  case $s in
  "hachiman.nils.moe")
