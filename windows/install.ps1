...
if (-Not ([Security.Principal.WindowsPrincipal] [Security.Principal.WindowsIdentity]::GetCurrent()).IsInRole([Security.Principal.WindowsBuiltInRole] 'Administrator')) {
	Start-Process -FilePath PowerShell.exe -Verb Runas -ArgumentList "-NoExit ``"irm https://raw.githubusercontent.com/nalsai/dotfiles/main/windows/install.ps1 | iex``""
	Exit
}

Set-ExecutionPolicy RemoteSigned -Scope LocalMachine -Force > $null
...
Clear-Host
Write-Host " _   _       _           _ _       ____        _    __ _ _           `n| \ | | __ _| |___  __ _(_| )___  |  _ \  ___ | |_ / _(_) | ___  ___ `n|  \| |/ _\`` | / __|/ _\`` | |// __| | | | |/ _ \| __| |_| | |/ _ \/ __|`n| |\  | (_| | \__ \ (_| | | \__ \ | |_| | (_) | |_|  _| | |  __/\__ \`n|_| \_|\__,_|_|___/\__,_|_| |___/ |____/ \___/ \__|_| |_|_|\___||___/`n"
		...
		Switch ($key.Character) {
			Default {
				try {
					...
					(Get-Item $Path).Delete() # bug workaround
				}
...
Set-ItemProperty "HKCU:\Software\Classes\Local Settings\Software\Microsoft\Windows\Shell\Bags\AllFolders\Shell" "FolderType" "NotSpecified" # Disable Folder Type Discovery
...
Set-ItemProperty "HKCU:\Software\Microsoft\Windows\CurrentVersion\Feeds" "ShellFeedsTaskbarViewMode" 2 -ErrorAction SilentlyContinue	# News and weather (Windows 10)
...
Set-ItemProperty "HKCU:\Software\Microsoft\Windows\CurrentVersion\Explorer\Advanced" "TaskbarDa" 0 -ErrorAction SilentlyContinue		# Widgets (Windows 11)
