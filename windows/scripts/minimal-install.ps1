...
choco install 7zip temurinjre altdrag cdburnerxp crystaldiskinfo curl edgedeflector everything ffmpeg firefox gimp googlechrome hwinfo icaros libreoffice-fresh microsoft-windows-terminal mpv nomacs notepad2-mod paint.net rclone vlc wget winbtrfs windirstat youtube-dl --limit-output
